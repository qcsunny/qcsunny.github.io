...
| 模型 | 输入（每 1M tokens） | 输出（每 1M tokens） | 缓存命中（每 1M tokens） | 备注 |
| --- | --- | --- | --- | --- |
| **Hy4 preview**（TokenHub 托管） | \$0.834 | \$2.501 | \$0.042 | 770B 主干，托管单价最高 |
| **GLM-5.3-Flash**（限时五折） | \$0.075（原 \$0.15） | \$0.25（原 \$0.50） | \$0.015（原 \$0.03） | 优惠至 2026-09-09 24:00 UTC+8 |
| **Qwen3.8-Flash**（国际 / Global 区） | \$0.15 | \$0.47 | 美元页未单列（人民币 ¥0.10） | 适用 1M context 以内 |
| **DeepSeek-V4-Flash**（非峰时） | \$0.22 | \$0.66 | \$0.007 | 周末全天及工作日非峰时段 |
| **DeepSeek-V4-Flash**（工作日峰时） | \$0.44 | \$1.32 | \$0.014 | 周一至周五 01:00–04:00 与 06:00–10:00 UTC |
| **MiMo-V2.5 标准版** | \$0.14 | \$0.28 | \$0.0028 | 全模态中单价最低 |

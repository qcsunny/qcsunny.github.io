...
- “三种原料按 $2.5 : 3.75 : 1.25$ 配比，如何防浮点误差地扩倍化简为整数连比？”
- “CSS 中的黄金分割比 $\phi$ 为什么不仅是美学法则，还能让动态排版的层级结构看起来极具确定感？”

这篇文章我们结合本站 [比例与比例方程计算器](/calculators/ratio/) 和 [百分比计算器](/calculators/percentage/) 的计算内核，把比例的约分算法、连比化简与黄金分割的代数性质讲明白。
...
| **16:10** | $1.6 : 1$ | 苹果 MacBook 系列屏幕、商务生产力笔记本（纵向视野多出 **11.1%**） |

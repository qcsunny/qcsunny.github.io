...
export const UNIT_CATEGORIES: UnitCategory[] = [
	...
	},
	{
		...
		units: {
			// Metric
			mL: lin('milliliter / cm³ (mL)', 0.001, '毫升 / 立方厘米 (cm³ / cc)', 'mL'),
	...
	},
	{
		...
		labelZh: '速度',
		units: {
			ms: lin('meter/second (m/s)', 1, '米/秒 (国际标准单位)', 'm/s'),
			kmh: lin('kilometer/hour (km/h)', 1 / 3.6, '千米/小时 (公里/小时)', 'km/h'),
			mph: lin('mile/hour (mph)', 0.44704, '英里/小时 (美英车速标准)', 'mph'),
			kn: lin('knot (kn)', 1852 / 3600, '节 / 浬/小时 (海里/小时，航海航空)', 'kn'),
			fts: lin('foot/second (ft/s)', 0.3048, '英尺/秒', 'ft/s'),
			mach: lin('Mach (Ma, 15°C海平面)', 340.29, '马赫 (标准海平面声速 ≈ 1225 km/h)', 'Ma'),
			c: lin('speed of light (c)', 299792458, '真空中光速 (约30万千米/秒)', 'c'),
			kms: lin('kilometer/second (km/s)', 1000, '千米/秒 (航天宇宙速度)', 'km/s'),
		},
	},
	{
		id: 'pressure',
		...
		units: {
			...
			kPa: lin('kilocal (kPa)', 1000, '千帕 (汽车胎压标准 250 kPa)', 'kPa'),
			MPa: lin('megapascal (MPa)', 1e6, '兆帕 (100万帕，材料强度与高压系统)', 'MPa'),
			...
			mmHg: lin('millimeter of mercury (mmHg / Torr)', 133.322387415, '毫米汞柱 / 托 (人体血压 120/80 mmHg 与真空)', 'mmHg'),
